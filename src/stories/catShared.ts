...
export const accessoryTraits = [''].concat('transparent,red riding basket,pumpkin candy bucket,ghost pirate hook,chugs balloon,blue balloon,red balloon,buneth,cupid bow'.split(','));
